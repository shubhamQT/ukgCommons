...
export class UkgcommonsPage {
  private static readonly L = {
    ...
    unsaveNews: { strategy: 'css' as const, value: 'button[aria-label="Unsave news"]', role: 'button', actionKind: 'button' as const },
    ...
    saveNews: { strategy: 'css' as const, value: 'button[aria-label="Save news"]', role: 'button', actionKind: 'button' as const },
    ...
    drakeTiwaryUkgCom: { strategy: 'css' as const, value: '.Header_headerTopRight__uHRnM', actionKind: 'generic' as const },
